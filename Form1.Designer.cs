namespace test
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            buttonSave.Location = new Point(1032, 5);
            ...
            labelStatus.Location = new Point(884, 8);
            ...
            checkBoxAcrostis.Location = new Point(1061, 51);
            ...
            labelCursorPos.Text = "1 line | 1 column";
            // 
            // checkBoxWordWrap
            // 
            ...
            comboFormat.Items.AddRange(new object[] { ".txt", ".rtf" });
            comboFormat.Location = new Point(1113, 5);
            comboFormat.Name = "comboFormat";
            comboFormat.Size = new Size(55, 23);
            comboFormat.TabIndex = 19;
            // 
            // buttonLoad
            // 
            buttonLoad.FlatStyle = FlatStyle.Flat;
            buttonLoad.Location = new Point(951, 5);
            ...
            // buttonMiniNote
            // 
            buttonMiniNote.FlatStyle = FlatStyle.Flat;
            buttonMiniNote.Location = new Point(1032, 48);
            buttonMiniNote.Name = "buttonMiniNote";
            buttonMiniNote.Size = new Size(22, 23);
            buttonMiniNote.TabIndex = 21;
            buttonMiniNote.Text = "▢";
            buttonMiniNote.UseVisualStyleBackColor = true;
            buttonMiniNote.Click += buttonMiniNote_Click;
            // 
            // Form1
            // 
